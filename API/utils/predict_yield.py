...
def predict_productivity(wheat_info):
    ...
    model_path = os.path.join(current_script_dir, '../models/Yield_neural_network_model/wheat_model.h5')
    scaler_path = os.path.join(current_script_dir,'../models/Yield_neural_network_model/scaler.pkl' )
